...
class Writer(models.Model):
    ...
    image = models.ImageField(verbose_name = "Imagen", upload_to="books")
...
class Book(models.Model):
    ...
    autor = models.ForeignKey(Writer, on_delete=models.CASCADE)
    ISBN = models.CharField(max_length = 150)
    img_front = models.ImageField(verbose_name = "Imagen Delantera", upload_to="books")
    img_back = models.ImageField(verbose_name = "Imagen Trasera", upload_to="books")
